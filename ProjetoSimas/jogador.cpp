...
void Jogador::mover() {
    ...
    // --- Movimento horizontal externo (repuls�o/knockback) ---
    movimento.x += velocidadeHorizontal * dt;

    // Aplica um "atrito" para que a velocidade de repuls�o diminua com o tempo
    velocidadeHorizontal *= 0.92f; // Fator de atrito, ajuste se necess�rio
    ...
    // --- Verifica��o de limites (l�gica original com melhorias) ---
